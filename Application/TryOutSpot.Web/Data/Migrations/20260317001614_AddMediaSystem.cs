        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoImageUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    ...
                    IsAcademy = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThrowsHand = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
                    BatsHand = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgeGroupDivisions = table.Column<string>(type: "text", nullable: true),
                    CompetitionLevels = table.Column<string>(type: "text", nullable: true),
                    TypicalPositions = table.Column<string>(type: "text", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    TeamLevel = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true),
                    LogoImageUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    PrimaryColor = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: true),
                    SecondaryColor = table.Column<string>(type: "character varying(7)", maxLength: 7, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryPosition = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    SecondaryPositions = table.Column<string>(type: "text", nullable: true),
                    ExperienceLevel = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    YearsPlaying = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
                    IsElite = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                name: "UserAdFrequencies",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<Guid>(type: "uuid", nullable: false),
                    LastAdShown = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    AdsShownToday = table.Column<int>(type: "integer", nullable: false),
                    AdsShownThisHour = table.Column<int>(type: "integer", nullable: false),
                    LastResetDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LastHourReset = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsAdFree = table.Column<bool>(type: "boolean", nullable: false),
                    AdFreeExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserAdFrequencies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserAdFrequencies_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPlayerRelationships", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserPlayerRelationships_Players_PlayerId",
                        column: x => x.PlayerId,
                        principalTable: "Players",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserPlayerRelationships_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GenderRequirement = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompetitionLevel = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    AgeGroup = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    TravelLevel = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TeamSports_Sports_SportId",
                        column: x => x.SportId,
                        principalTable: "Sports",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeamSports_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "OpportunityGeographicTargets",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    OpportunityId = table.Column<Guid>(type: "uuid", nullable: false),
                    TargetZipCode = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OpportunityGeographicTargets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OpportunityGeographicTargets_Opportunities_OpportunityId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "numeric", nullable: true),
                    MedicalInfo = table.Column<string>(type: "text", nullable: true),
                    ...
                    WaiverSignerName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Registrations_Opportunities_OpportunityId",
                        column: x => x.OpportunityId,
                        principalTable: "Opportunities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Registrations_Users_RegisteredByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OpportunityGeographicTargets_OpportunityId",
                table: "OpportunityGeographicTargets",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registrations_OpportunityId",
                table: "Registrations",
                column: "OpportunityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registrations_RegisteredByUserId",
                table: "Registrations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamSports_SportId",
                table: "TeamSports",
                column: "SportId");

            migrationBuilder.CreateIndex(
                name: "IX_TeamSports_TeamId",
                table: "TeamSports",
                column: "TeamId");

            migrationBuilder.CreateIndex(
                name: "IX_UserAdFrequencies_UserId",
                table: "UserAdFrequencies",
                column: "UserId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPlayerRelationships_PlayerId",
                table: "UserPlayerRelationships",
                column: "PlayerId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPlayerRelationships_UserId",
                table: "UserPlayerRelationships",
                column: "UserId");
